...
function RecruiterWordcloud(props) {
...
function getUniqueListBy(arr, key) {
  ...
  const arryOfOB = props.topicsByCandidateId.map((item,i) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(RecruiterWordcloud);
