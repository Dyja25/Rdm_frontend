...
function RecruitForm(props) {
  ...
  const processOption = useMemo(() => {
    debugger;
    if (!props.recruitPublishProcess) return [];
    return (
      props.recruitPublishProcess.length &&
      props.recruitPublishProcess.map((process) => {
        return {
  ...
  useEffect(() => {
    props.getPublishProcessForRecruit(props.orgId);
  //   props.getCurrency();
...
const mapStateToProps = ({
  ...
  recruitPublishProcess: opportunity.recruitPublishProcess,
