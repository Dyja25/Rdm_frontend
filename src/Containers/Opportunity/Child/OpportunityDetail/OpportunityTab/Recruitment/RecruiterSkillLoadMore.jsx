...
function RecruiterSkillLoadMore(props) {
...
// // });
 ...
 const newSkill=props.matchSkill.map((item)=> {
   return { matchSkill:item, color: generateRandomColor() };
     });
...
export default RecruiterSkillLoadMore;
