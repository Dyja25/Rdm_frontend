...
export const GET_PUBLISH_PROCESS_FOR_RECRUIT_REQUEST =
  "GET_PUBLISH_PROCESS_FOR_RECRUIT_REQUEST";
export const GET_PUBLISH_PROCESS_FOR_RECRUIT_SUCCESS =
  "GET_PUBLISH_PROCESS_FOR_RECRUIT_SUCCESS";
export const GET_PUBLISH_PROCESS_FOR_RECRUIT_FAILURE =
  "GET_PUBLISH_PROCESS_FOR_RECRUIT_FAILURE";

    export const DELETE_SUBTABLE_DATA_REQUEST =
  "DELETE_SUBTABLE_DATA_REQUEST";
export const DELETE_SUBTABLE_DATA_SUCCESS =
  "DELETE_SUBTABLE_DATA_SUCCESS";
export const DELETE_SUBTABLE_DATA_FAILURE =
  "DELETE_SUBTABLE_DATA_FAILURE";
