...
export const emptyblueCandidate = () => (dispatch) => {
  dispatch({
    type: types.EMPTY_BLUE_CANDIDATE_TABLE,
    ...
    .then((res) => {
      if (res.data.candidateInd === true) {
        ...
        const endDate = dayjs()
          .endOf("month")
          .toISOString();
        // dispatch(getCandidateListByUserId(userId,"0"));
 ...
 */
export const getCandidateListByUserId = (userId,pageNo) => (dispatch) => {
  dispatch({
    type: types.GET_CANDIDATES_REQUEST,
  });
  axios
    .get(`${base_url}/candidate/user/${userId}/${pageNo}`, {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
...
export const inputCandidateDataSearch = (skill) => (dispatch) => {
  ...
  axios
    .get(`${base_url}/candidate/search/all/type/${skill}`, {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
...
export const shareCandidatePermission = (pageNo, userId, a) => (
  dispatch,
  getState
) => {
  // const { userId } = getState("auth").auth.userDetails;
  ...
  axios
    .get(`${base_url}/candidate/all-candidate/${pageNo}`,  {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
...
export const linkCandidateStatus = (data, candidateId) => (
  ...
  axios
    .put(`${base_url}/candidate/active/inActive/${candidateId}`, data, {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
...
export const getRecordsBlack = (userId) => (dispatch) => {
  dispatch({
    type: types.GET_RECORDS_BLACK_REQUEST,
  });
  axios
    .get(`${base_url}/candidate/blackListcount/${userId}`, {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
    .then((res) => {
      console.log(res);
      dispatch({
        type: types.GET_RECORDS_BLACK_SUCCESS,
        payload: res.data,
      });
    })
    .catch((err) => {
      console.log(err.response);
      dispatch({
        type: types.GET_RECORDS_BLACK_FAILURE,
        payload: err,
      });
    });
};

export const getRecordsDelete = (userId) => (dispatch) => {
  dispatch({
    type: types.GET_RECORDS_DELETE_REQUEST,
  });
  axios
    .get(`${base_url}/candidate/deleted/candidate/listCount/${userId}`, {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
...
export const getUnbolckCandidate = (candidateId,candidate) => (dispatch,getState) => {
  const { userId } = getState("auth").auth.userDetails;
  dispatch({
    type: types.GET_UNBLOCK_CANDIDATE_REQUEST,
  });
  axios
  .put(`${base_url}/candidate/unblock/${candidateId}`, candidate, {
    headers: {
      Authorization: "Bearer " + sessionStorage.getItem("token") || "",
    },
  })
    .then((res) => {
      console.log(res);
      dispatch(getCandidateBlackList(userId));
      dispatch({
        type: types.GET_UNBLOCK_CANDIDATE_SUCCESS,
        payload: res.data,
      });
    })
    .catch((err) => {
      console.log(err.response);
      dispatch({
        type: types.GET_UNBLOCK_CANDIDATE_FAILURE,
        payload: err,
      });
    });
};
...
export const getFilteredEmailContact = (userId) => (dispatch) => {
  ...
  axios
    .get(`${base_url}/contact/Email/user/${userId}`, {
      headers: {
        Authorization: "Bearer " + sessionStorage.getItem("token") || "",
      },
    })
  ...
  export const deleteCandidateData = ( candidateId,data ) => (dispatch) => {
    dispatch({ type: types.DELETE_CANDIDATE_DATA_REQUEST });
  
    axios
      .put(`${base_url}/candidate/delete/${candidateId} `, data, {
        headers: {
          Authorization: "Bearer " + sessionStorage.getItem("token") || "",
        },
      })
      ...
      .then((res) => {
        console.log(res);
        dispatch({
          type: types.DELETE_CANDIDATE_DATA_SUCCESS,
          payload: candidateId,
        });
        // cb && cb("success");
      })
      .catch((err) => {
        console.log(err);
        dispatch({
          type: types.DELETE_CANDIDATE_DATA_FAILURE,
        });
        // cb && cb("failure");
      });
  };
  export const getDeletedCandidate = (userId,pageNo) => (dispatch) => {
    dispatch({
      type: types.GET_DELETED_CANDIDATE_REQUEST,
    });
    axios
      .get(`${base_url}/candidate/deleted/candidate/list/${userId}/${pageNo}`, {
        headers: {
          Authorization: "Bearer " + sessionStorage.getItem("token") || "",
        },
      })
      .then((res) => {
        console.log(res);
        dispatch({
          type: types.GET_DELETED_CANDIDATE_SUCCESS,
          payload: res.data,
        });
      })
      .catch((err) => {
        console.log(err);
        dispatch({
          type: types.GET_DELETED_CANDIDATE_FAILURE,
          payload: err,
        });
      });
  };

  export const reinstateToggleForCandidate = (data, candidateId,userId) => (dispatch) => {
    // debugger;
    dispatch({
      type: types.REINSTATE_TOGGLE_FOR_CANDIDATE_REQUEST,
    });
    axios
      .put(`${base_url}/candidate/delete/${candidateId} `, data, {
        headers: {
      ...
      .then((res) => {
        ...
        dispatch({
          type: types.REINSTATE_TOGGLE_FOR_CANDIDATE_SUCCESS,
          payload: candidateId,
        });
        message.success("candidate reinstate Successfully");
      })
      .catch((err) => {
        console.log(err);
        dispatch({
          type: types.REINSTATE_TOGGLE_FOR_CANDIDATE_FAILURE,
          payload: err,
        });
  ...
  export const getValidEmail = (emailId) => (dispatch) => {
    dispatch({
      type: types.GET_VALID_EMAIL_REQUEST,
    });
    axios
      .get(`${base_url}/candidate/email/verification/${emailId}`, {
        headers: {
          Authorization: "Bearer " + sessionStorage.getItem("token") || "",
        },
      })
      .then((res) => {
        console.log(res);
        dispatch({
          type: types.GET_VALID_EMAIL_SUCCESS,
          payload: res.data,
        });
      })
      .catch((err) => {
        console.log(err);
        dispatch({
          type: types.GET_VALID_EMAIL_FAILURE,
          payload: err,
        });
      });
  };