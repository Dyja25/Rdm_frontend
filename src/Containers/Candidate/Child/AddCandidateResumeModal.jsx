...
const ResumeForm = lazy(() => import("./ResumeForm.jsx"));

const AddCandidateResumeModal = (props) => {
  const {addCandidateResumeModal,handleCandidateResumeModal, ...formProps } = props;
  ...
  return (
    <>
      <StyledModal
        ...
        style={{ top: 40 }}
        onCancel={() => handleCandidateResumeModal(false)}
        footer={null}
      >
