...
const initialState = {
  ...
  fetchingRecordsByBlack: false,
  fetchingRecordsByBlackError: false,
  recordDataBlack:{},

  fetchingRecordsByDelete: false,
  fetchingRecordsByDeleteError: false,
  recordDataDelete:{},

  fetchingUnblockCandidate: false,
  fetchingUnblockCandidateError: false,
  ...
  fetchingDeletedCandidate: false,
  fetchingDeletedCandidateError: false,
  deletedCandidate: [],
 ...
 // candidatePagination: [],
  ...
  deleteCandidateData: false, 
  deleteCandidateDataError: false,
  //skills
  ...
  fetchingValidEmail:false,
  fetchingValidEmailError:false,
  validEmail:{},
  ...
  reInstateToggleForCandidate: false,
  reInstateToggleForCandidateError: false,
  ...
  switch (action.type) {
      ...
      case types.HANDLE_UPDATE_CANDIDATE_RESUME_MODAL:
        ...
        case types.HANDLE_CHOICE_CANDIDATE_MODAL:
          ...
          case types.EMPTY_CANDIDATE_TABLE:
            ...
            case types.EMPTY_BLUE_CANDIDATE_TABLE:
    ...
    case types.HANDLE_UPDATE_CANDIDATE_MODAL:
      ...
      case types.HANDLE_CANDIDATE_EMAIL_MODAL:
        return { ...state, addCandidateEmailModal: action.payload };
    ...
    case types.GET_CANDIDATES_SUCCESS:
      return {
        ...state,
        fetchingCandidates: false,
        candidateByUserId: [...state.candidateByUserId, ...action.payload],
        // candidateByUserId: [
    ...
    case types.GET_RECORDS_FAILURE:
      ...
      case types.GET_RECORDS_BLACK_REQUEST:
        return { ...state, fetchingRecordsByBlack: true };
      case types.GET_RECORDS_BLACK_SUCCESS:
        return {
          ...state,
          fetchingRecordsByBlack: false,
          recordDataBlack: action.payload,
        };
      case types.GET_RECORDS_BLACK_FAILURE:
        return {
          ...state,
          fetchingRecordsByBlack: false,
          fetchingRecordsByBlackError: true,
        };

        case types.GET_RECORDS_DELETE_REQUEST:
          return { ...state, fetchingRecordsByDelete: true };
        ...
        case types.GET_RECORDS_DELETE_FAILURE:
          return {
            ...state,
            fetchingRecordsByDelete: false,
            fetchingRecordsByDeleteError: true,
          };
      ...
      case types.GET_CANDIDATE_FILTER_FAILURE:
        ...
        case types.UPDATE_CANDIDATE_OWNERSHIP_SUCCESS:
          return {
            ...
            //   }
            // }),
            candidatePagination:state.candidatePagination.filter(
              (item)=>{
        ...
        case types.UPDATE_CANDIDATE_OWNERSHIP_SUCCESS:
          ...
          case types.HANDLE_CANDIDATE_REACT_SPEECH_MODAL:
            ...
            case types.ADD_CANDIDATE_NOTES_FAILURE:
              ...
              case types.CHOOSE_CANDIDATE_FAILURE:
                ...
                case types.GET_VALID_EMAIL_REQUEST:
                  return { ...state, fetchingValidEmail: true };
                case types.GET_VALID_EMAIL_SUCCESS:
                  return { ...state, fetchingValidEmail: false, validEmail: action.payload };
                case types.GET_VALID_EMAIL_FAILURE:
                  return { ...state, fetchingValidEmail: false, fetchingValidEmailError: true };
                ...
                case types.GET_BLACKLIST_CANDIDATE_FAILURE:
                  ...
                  case types.GET_UNBLOCK_CANDIDATE_REQUEST:
                  return { ...state, fetchingUnblockCandidate: true };
                case types.GET_UNBLOCK_CANDIDATE_SUCCESS:
                  return {
                    ...state,
                    fetchingUnblockCandidate: false,
                ...
                case types.GET_UNBLOCK_CANDIDATE_FAILURE:
                  return {
                    ...state,
                    fetchingUnblockCandidate: false,
                    fetchingUnblockCandidateError: true,
                  };
          ...
          case types.DELETE_CANDIDATE_DATA_REQUEST:
            return { ...state, deleteCandidateData: true };
          case types.DELETE_CANDIDATE_DATA_SUCCESS:
            return {
              ...state,
              deleteCandidateData: false,
          ...
          case types.DELETE_CANDIDATE_DATA_FAILURE:
            return { ...state, deleteCandidateData: false, deleteCandidateDataError: false };


            case types.GET_DELETED_CANDIDATE_REQUEST:
              return { ...state, fetchingDeletedCandidate: true };
            case types.GET_DELETED_CANDIDATE_SUCCESS:
              return {
                ...state,
                fetchingDeletedCandidate: false,
                deletedCandidate: [...state.deletedCandidate, ...action.payload],

              
              };
            case types.GET_DELETED_CANDIDATE_FAILURE:
              return {
                ...state,
                fetchingDeletedCandidate: false,
                fetchingDeletedCandidateError: true,
              };
            ...
            return { ...state, candidateByCategory:[] };
              ...
              case types.REINSTATE_TOGGLE_FOR_CANDIDATE_REQUEST:
                return { ...state, reInstateToggleForCandidate: true };
           case types.REINSTATE_TOGGLE_FOR_CANDIDATE_SUCCESS:
          return {
            ...state,
            reInstateToggleForCandidate: false,
            deletedCandidate: state.deletedCandidate.filter(
              (item) => item.candidateId !== action.payload
           ),
         };
       case types.REINSTATE_TOGGLE_FOR_CANDIDATE_FAILURE:
           return {
            ...state,
            reInstateToggleForCandidate: false,
            reInstateToggleForCandidateError: true,
          };
