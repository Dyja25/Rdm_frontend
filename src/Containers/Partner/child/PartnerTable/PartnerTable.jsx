...
import { CompassOutlined, DeleteOutlined, EditOutlined, GlobalOutlined, SearchOutlined } from "@ant-design/icons";
...
import { Tooltip,Button,Input,Select, message } from "antd";
...
function handleCallback(data){
  if(data==="success"){
    message.success("selected Partner")
    props.emptyPartner()
    props.getPartnerListByUserId(props.userId,page);
    
  }else{
    message.error("some error there")
  }
}
...
<InfiniteScroll
      ...
      <StyledTable
        ...
        columns={columns}
        pagination={false}
        dataSource={props.partnerByUserId}
        // dataSource={allpartnerByUserId}
        Loading={props.fetchingPartners || props.fetchingPartnersError}
