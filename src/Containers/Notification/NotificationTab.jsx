...
import { Tabs, Button, List, Checkbox } from 'antd';
        ...
        return (
            <div>
                <Tabs defaultActiveKey={"2"} scrollToActive={true} style={{ width: 400 }}>
                    <TabPane key={"1"} tab={<span style={{ color: 'skyblue' }}>Previous</span>}>
                        <PastNotification />
                    </TabPane>
                    <TabPane key={"2"} tab={<span style={{ color: 'lightgreen' }}>Today</span>}>
                        <PresentNotification />
                    </TabPane>
