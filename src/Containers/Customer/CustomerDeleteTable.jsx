...
import ReinstateToggleForCustomer from "./ReinstateToggleForCustomer.jsx";
const CustomerDetailView=lazy(()=>import("./Child/CustomerTable/CustomerDetailView.jsx"));
const UpdateCustomerModal=lazy(()=>import("./Child/UpdateCustomer/UpdateCustomerModal.jsx"));
const Option =Select;
function onChange(pagination, filters, sorter) {
  console.log("params", pagination, filters, sorter);
}

function CustomerDeleteTable(props) {
...
const [selectedValue,setselectedValue]=useState("");
  ...
  useEffect(() => {
    props.getCustomerDeleteData(props.userId);
  ...
  const columns = [
    ...
    // },
    {
      ...
      render: (name, item, i) => {
        ...
        return (
          <>
          <span style={{ color: "#09477efa",marginLeft:"4px" }}><CustomerDetailView customerId={item.customerId} name={item.name} /></span>
          &nbsp;&nbsp;
            {date === currentdate ? (
              <span
                style={{
  ...
  return (
    ...
    Transfer
      ...
      <StyledTable
        ...
        columns={columns}
        dataSource={customerDeleteData}
        loading={props.fetchingCustomerDeleteData || props.fetchingCustomerDeleteDataError }
...
const mapStateToProps = ({ auth, customer,sector,opportunity }) => ({
  ...
  customerDeleteData: customer.customerDeleteData,
  fetchingCustomerDeleteData: customer.fetchingCustomerDeleteData,
  fetchingCustomerDeleteDataError: customer.fetchingCustomerDeleteDataError,
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerDeleteTable);
