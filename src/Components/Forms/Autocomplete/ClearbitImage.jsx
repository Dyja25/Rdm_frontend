...
//             return (
//                 <>
//                     <div class=" text-xs font-bold font-poppins">{label}</div>
//                     <StyledAsync
//                         isRequired={isRequired}
//                         classNamePrefix="sales"
//                         placeholder={placeholder}
...
//                     <div className=" items-center" flexWrap={inlineLabel && "nowrap"}>
//                         <div class=" text-xs font-bold font-poppins">{label}</div>
//                         <StyledAsync
//                             isRequired={isRequired}
//                             classNamePrefix="sales"
...
class ClearbitImage extends Component {
  ...
  handleOnChange = (option) => {
    // If used inside Formik
    if (this.props.form?.setFieldValue) {
      this.props.form.setFieldValue("name", option.value);
      this.props.form.setFieldValue("url", option.website);
      this.props.form.setFieldValue("imageURL", option.logo);
    }
    // Always call redux action
    this.props.setClearbitData(option);
     if (this.props.onCompanySelect) {
    this.props.onCompanySelect(option);
  }
     if (this.props.addNewCustomer) {
  ...
  // Close the node after selecting
  ...
  render() {
    ...
    if (isColumn) {
      return (
        <>
          <div className="text-xs font-bold font-poppins">{label}</div>
          <StyledAsync
            isRequired={isRequired}
            classNamePrefix="sales"
            placeholder={placeholder}
    ...
    return (
      <>
        <div className="flex flex-row flex-wrap items-start self-start justify-start grow shrink h-auto mr-auto">
          <div className="items-center" flexwrap={inlineLabel && "nowrap"}>
            <div className="text-xs font-bold font-poppins">{label}</div>
            <StyledAsync
              isRequired={isRequired}
